      ...
      <div className="cart">
        ...
        <div className="content__items">
          <div className="cart__item">
            <div className="cart__item-img">
              <img
                ...
                src="https://yapiko.ua/media/catalog/product/cache/90c631851bfc82ed3538a672fa9488bb/p/i/pizza_with_persimmon_and_truffle.webp"
                alt="Pizza"
              />
            </div>
            <div className="cart__item-info">
              <h3>Піца з хурмою та трюфелем</h3>
          ...
          <div className="cart__item">
            <div className="cart__item-img">
              <img
                className="pizza-block__image"
                src="https://yapiko.ua/media/catalog/product/cache/90c631851bfc82ed3538a672fa9488bb/g/r/greek_pizza.webp"
                alt="Pizza"
              />
            </div>
            <div className="cart__item-info">
          ...
          <div className="cart__item">
            <div className="cart__item-img">
              <img
                className="pizza-block__image"
                src="https://yapiko.ua/media/catalog/product/cache/90c631851bfc82ed3538a672fa9488bb/p/i/pizza_tom_yam_new_pizza.webp"
                alt="Pizza"
              />
            </div>
            <div className="cart__item-info">
          ...
          <div className="cart__item">
            <div className="cart__item-img">
              <img
                className="pizza-block__image"
                src="https://yapiko.ua/media/catalog/product/cache/90c631851bfc82ed3538a672fa9488bb/p/i/pizza_4_flavors_updated.webp"
                alt="Pizza"
              />
            </div>
            <div className="cart__item-info">
        ...
        <div className="cart__bottom">
          ...
          <div className="cart__bottom-buttons">
            ...
            <button className='button pay-btn' type='button'><span>Оплатити зараз</span></button>
          </div>
        </div>
      </div>
    </div>
